 ...
 //Type your controller code here 
	showForm: function (){  	  
  	...
  	onDelete:function(){
      	...
      	var jsonObj={rows:this.getSegmentRows(), widgets : ["flxBtnDelete"], animation: this.btnAnimation("0%")};
      	this.view.segListPerson.animateRows(jsonObj);
    },
  	onDone:function(){
      	this.view.btnDone.isVisible=false;
      	this.view.btnEdit.isVisible=true;
      	var jsonObj={rows:this.getSegmentRows(), widgets : ["flxBtnDelete"], animation: this.btnAnimation("-11%")};
      	this.view.segListPerson.animateRows(jsonObj);
    },
